...
from utils.utils import save_checkpoint, AverageMeter, Logger, accuracy, mkdirs, adjust_learning_rate, time_to_str, to_categorical_ml
...
def train():
    ...
    num_cluster, dim, alpha, stride, vlad_alpha, adap = 16, 128, 3., 1, False, False
    ...
    for iter_num in range(max_iter+1):
        ...
        #Loss_triplet = TripletLossCal([input1_shape, input2_shape, input3_shape], feature, source_label, W_intra)
        ######### cross-entropy loss #########
