class DefaultConfigs(object):
    ...
    checkpoint_ID_path = './' + tgt_data + '_checkpoint/' + model + '/DGFANet/' + 'MSU_ID.pth.tar'
    checkpoint_ID_domain_path = './' + tgt_data + '_checkpoint/' + model + '/DGFANet/' + 'MSU_ID_domain.pth.tar'
    logs = './logs/'
